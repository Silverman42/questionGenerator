...
(function() {
    if ($('#js-faculty').index() == 0) {
        ...
        const FacultyView = function() {
            ...
            this.createSuccessAlert = $('#FacSuccessAlert'); //DOM object for success alert
            this.createErrorAlert = $('#FacErrorAlert'); //DOM object for error alert
        ...
        FacultyModel.prototype = {
            ...
            transferFacData:function (domObject) {
            	...
            	ModalDataTransfer.headerData = {'#modalFacHeader': $('.FacName')} ; //Data to be transfered to the modal's header
            	ModalDataTransfer.formActionData = {'#updateFaculty': $('.FacName')}; //Data to be transfered to the action attribute of the modal's form
            	ModalDataTransfer.inputData = {'#qg-update-name':$('.FacName'), '#qg-update-description':$('.FacDescription')}; //Data to be transfered to the input's value of the modal's form
